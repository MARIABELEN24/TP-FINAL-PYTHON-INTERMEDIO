...
class Frame(tk.Frame):  
    ...
    def label_form(self):    
        ...
        self.label_nombre = tk.Label(self, text="Año: ")    
        self.label_nombre.config(font=('Arial',12,'bold'))    
    ...
    def input_form(self):
        ...
        self.entry_puntuacion = tk.Entry(self, textvariable=self.puntuacion)    
        self.entry_puntuacion.config(width=50)    
        self.entry_puntuacion.grid(row= 3, column=1,padx=10,pady=10)  

        self.año = tk.StringVar()    
        self.entry_año = tk.Entry(self, textvariable=self.año)    
        self.entry_año.config(width=50)    
        self.entry_año.grid(row= 4, column=1,padx=10,pady=10)  
    ...
    def mostrar_tabla(self):
        ...
        self.tabla = ttk.Treeview(self, columns=('Nombre','Duración','Genero','Puntuación','Año'))
        ...
        self.tabla.heading('#4', text='Puntuacion')
    ...
    def editar_registro(self):
        try:
            ...
            self.punt_peli = self.tabla.item(self.tabla.selection())['values'][3]
            ...
            self.puntuacion.set(self.punt_peli)
            self.año.set(self.anio_peli)
        except:
            pass
